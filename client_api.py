...
res = requests.get('http://192.168.1.103:5000/diag/')
if res.ok:
    print("GET")
...
print(msg_)
res = requests.post('http://192.168.1.103:5000/train/', json=msg_)
...
msg_ = {"symptomid": rand_(), "age": "40", "gender": "male"}
res = requests.post('http://192.168.1.103:5000/diag/', json=msg_)
